...
# Domainmod
ARG DOMAINMOD_WEB_ROOT
ARG DOMAINMOD_DATABASE_HOST
ARG DOMAINMOD_DATABASE
ARG DOMAINMOD_USER
ARG DOMAINMOD_PASSWORD
ENV DOMAINMOD_WEB_ROOT=${DOMAINMOD_WEB_ROOT}
ENV DOMAINMOD_DATABASE_HOST=${DOMAINMOD_DATABASE_HOST}
ENV DOMAINMOD_DATABASE=${DOMAINMOD_DATABASE}
...
COPY config/domainmod/logout.php /var/www/new_version/
